...
class CoinRepositoryImpl @Inject constructor(private val api:CoinPaprikaApi):CoinRepository {
    ...
    override suspend fun getCoinHistoricalPriceById(coinId: String, Current:String): List<CoinHistoricalPriceDto> {
        return api.getCoinHistoricalPriceById(coinId, Current)
    }
}